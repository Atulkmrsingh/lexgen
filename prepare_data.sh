#bash prepare_data.sh ../final_data/ en hi /home/ganesh/udaan-indictrans/en-indic/final_bin
exp_dir=$1
src_lang=$2
tgt_lang=$3
pre_trained_model_vocab=$4
train_data_dir=${5:-"$exp_dir/$src_lang-$tgt_lang"}
devtest_data_dir=${6:-"$exp_dir/devtest/$src_lang-$tgt_lang"}
...
bash binarize_training_exp.sh $exp_dir SRC TGT  $pre_trained_model_vocab