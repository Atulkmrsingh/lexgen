...
do
    ...
    python $SUBWORD_NMT_DIR/subword_nmt/apply_bpe.py \
        -c $pretrained_dir/vocab/bpe_codes.32k.SRC \
        --vocabulary $pretrained_dir/vocab/vocab.SRC \
    ...
    # parallel --pipe --keep-order \
    python $SUBWORD_NMT_DIR/subword_nmt/apply_bpe.py \
        -c $pretrained_dir/vocab/bpe_codes.32k.TGT \
        --vocabulary $pretrained_dir/vocab/vocab.TGT \
        --vocabulary-threshold 5 \
        --num-workers "-1" \
        < $in_dset_dir.TGT \
        > $out_dset_dir.TGT
