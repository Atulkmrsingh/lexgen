...
def collate_tokens(
    ...
    # domain_tok = {32062: '<admin>', 32063: '<chem>', 32065: '<biotech>', 32097: '<agri>', 32098: '<broadcast>', 32099: '<civil>', 32100: '<comp>', 32101: '<geo>', 32102: '<psycho>',32103: '<maths>'} # get_domain_list() # Modified by Ayush - Get domain list
    domain_tok = {32094: '<admin>', 32095: '<chem>', 32096: '<biotech>', 32097: '<agri>', 32098: '<broadcast>', 32099: '<civil>', 32100: '<comp>', 32101: '<geo>', 32102: '<psycho>',32103: '<maths>'} # get_domain_list() # Modified by Ayush - Get domain list
