...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        # print("src tokens",net_input["src_tokens"].shape)
        # print("domain matrix",net_input["domain_matrix"].shape)
        domain_matrix = net_input["domain_matrix"]
        
        # print('inside sequence generator ', net_input["domain_matrix"].shape, " ",net_input["src_tokens"].shape," ",net_input["src_lengths"].shape)
        ...
        domain_matrix=domain_matrix.repeat(beam_size) #repeating it by beam size
        ...
        for step in range(max_len + 1):  # one extra step for EOS marker
            ...
            # print("finalized sentence",len(finalized_sents))
            ...
            if len(finalized_sents) > 0:
                ...
                domain_matrix = domain_matrix[batch_idxs]
                domain_matrix=domain_matrix.repeat(beam_size)
                ...
                # print("token 1 shape",tokens.shape)
                scores = scores.view(bsz, -1)[batch_idxs].view(new_bsz * beam_size, -1)
                tokens = tokens.view(bsz, -1)[batch_idxs].view(new_bsz * beam_size, -1)
                # print("token 2 shape",tokens.shape)
                if attn is not None:
